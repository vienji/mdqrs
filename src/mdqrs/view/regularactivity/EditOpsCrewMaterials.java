 ...
 * @author Vienji
 */
public class EditOpsCrewMaterials extends javax.swing.JFrame {
    private static EditOpsCrewMaterials instance;
    private static MainListener mainListener;
    private static CrewMaterials operationCrewMaterials;
    private static int index;
    private static int formType;
    /**
     * Creates new form AddOpsCrewMaterials
     */
    private EditOpsCrewMaterials() {
        initComponents();
        initData();
    ...
    public static EditOpsCrewMaterials getInstance(){
        if(instance == null){
            instance = new EditOpsCrewMaterials();
        }
    ...
    private void initData(){
        description.setText(operationCrewMaterials.getDescription());
        quantity.setText(String.valueOf(operationCrewMaterials.getQuantity()));
        unit.setText(operationCrewMaterials.getUnit());
    }
    
    public static void setData(int i, CrewMaterials crewMaterials){
        operationCrewMaterials = crewMaterials;
        index = i;
    }
    ...
    private void initComponents() {
        ...
        setTitle("Edit Operation Crew Materials");
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditOpsCrewMaterials.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditOpsCrewMaterials().setVisible(true);
            }
        });
    }
