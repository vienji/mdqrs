...
public class EditPersonnel extends javax.swing.JFrame {
     ...
     */
    private EditPersonnel() {
        initComponents();
        addWindowListener(new CloseWindow());
        boolean isOtherType = personnel.getIsOtherType().equalsIgnoreCase("true");
        name.setText(personnel.getName());
        String jobType = isOtherType ? "Other" : personnel.getType();
        type.setSelectedItem(jobType);
        otherType.setEnabled(isOtherType);
        if(isOtherType){
            otherType.setText(personnel.getType());
        }
        ratePerDay.setText(String.valueOf(personnel.getRatePerDay()));
    }
    
    public static EditPersonnel getInstance(){
        if(instance == null){
            instance = new EditPersonnel();
        }
    ...
    public static void setData(Personnel personnelData){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditPersonnel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditPersonnel().setVisible(true);
            }
        });
    }
