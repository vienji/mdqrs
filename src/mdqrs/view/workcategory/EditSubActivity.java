 ...
 * @author Vienji
 */
public class EditSubActivity extends javax.swing.JFrame {
    private static MainListener mainListener;
    private static EditSubActivity instance;
    ...
    public static EditSubActivity getInstance(){
        if(instance == null){
            instance = new EditSubActivity();
        }
    ...
    public static void setData(SubActivity e){
        subActivity = e;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditSubActivity.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditSubActivity().setVisible(true);
            }
        });
    }
